...
class LeakScenarioCatalogTest {
    ...
    @Test
    fun defaultScenario_isTheFirstScenario() {
        val scenarios = LeakScenarioCatalog.allScenarios()
        assertEquals(scenarios.first(), LeakScenarioCatalog.defaultScenario())
    }

    @Test
    fun toDisplayText_includesAllCoreFields() {
        val scenario = LeakScenarioCatalog.defaultScenario()
